                ...
                <div class="row">
                    <div class="dashboard-sidebar collapse show" id="collapseExample">
                        ...
                        <div class="sidebar-menu">
                            <?php include $_SERVER['DOCUMENT_ROOT'].'/QLNS-php/src/views/modules/user-sidebar.php'?>
                        </div>
                    </div>
                    <div class="dashboard-main flex-1">
                        ...
                        <div class="dashboard-content">
                            <?php include $_SERVER['DOCUMENT_ROOT'].'/QLNS-php/src/views/modules/overview-user.php'?>
                        </div>
                    </div>
                </div>
                <!-- Sidebar -->
